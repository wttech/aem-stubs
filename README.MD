...
* [repository](https://bitbucket.cognifide.com/users/krystian.panek/repos/aem-stubs/browse/core/src/main/java/com/cognifide/aem/stubs/core/script/Repository.java) - for easier using repository e.g reading file contents,
