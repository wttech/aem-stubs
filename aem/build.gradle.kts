    ...
    tasks {
        instanceSatisfy {
            ...
            packages {
                ...
                "jetty.io" {resolve("org.eclipse.jetty:jetty-io:9.4.20.v20190813")}
                "jetty.xml" {resolve("org.eclipse.jetty:jetty-xml:9.4.20.v20190813")}
                ...
                "jetty.security" {resolve("org.eclipse.jetty:jetty-security:9.4.20.v20190813")}
